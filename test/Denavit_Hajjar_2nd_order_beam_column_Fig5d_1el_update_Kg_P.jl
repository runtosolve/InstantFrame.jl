...
solution = nlsolve((R,uf) ->residual!(R, uf, Ke_ff, Ff, free_global_dof, ke_local, uniform_load, local_fixed_end_forces, properties, node), u1f, method = :newton)


function residual!(R, uf, Ke_ff, Ff, free_global_dof, ke_local, uniform_load, local_fixed_end_forces, properties, node)
