...
cross_section = InstantFrame.CrossSection(names=["beam"], A=[1.0], Iy=[0.627], Iz=[0.627], J=[0.001])
...
node = InstantFrame.Node(numbers=[1, 2], coordinates=[(0.0, 0.0, 0.0), (96.0, 0.0, 0.0)])

element = InstantFrame.Element(numbers=[1], nodes=[(1,2)], orientation=[0.0, 0.0], connections=[("end release", "end release")], cross_section=["beam"], material=["steel"])

support = InstantFrame.Support(nodes=[1, 2], stiffness=(uX=[Inf,Inf], uY=[Inf,Inf], uZ=[Inf,Inf], rX=[Inf,Inf], rY=[Inf,Inf], rZ=[Inf,Inf]))
