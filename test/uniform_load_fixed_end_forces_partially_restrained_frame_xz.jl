...
connection = InstantFrame.Connection(names=["rigid", "end release"], stiffness=(ux=[Inf, Inf], uy=[Inf, Inf], uz=[Inf, Inf], rx=[Inf, Inf], ry=[Inf, 230000], rz=[Inf, Inf]))

node = InstantFrame.Node(numbers=[1, 2, 3, 4, 5, 6], coordinates=[(0.0, 0.0, 0.0), (96.0, 0.0, 0.0), (0.0, 0.0, 48.0), (0.0, 0.0, -48.0), (96.0, 0.0, 48.0), (96.0, 0.0, -48.0)])
...
uniform_load = InstantFrame.UniformLoad(labels=["test"], elements=[1], loads=(qX=[0.0], qY=[0.0], qZ=[-12.5], mX=[0.0], mY=[0.0], mZ=[0.0]))
